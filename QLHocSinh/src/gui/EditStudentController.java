...
public class EditStudentController implements Initializable{
	...
	public void setCodeTF(String code) {
	...
	public void setUrlTF(String url) {
		this.urlTF.setText(url);
	}
	...
	public void setClass(String class_) {
		classChoiceBox.setValue(class_);
	}
	
	public void setHometown(String hometown) {
		hometownChoiceBox.setValue(hometown);
	}
	...
	public void onClickUpdateButton() throws ParseException {
		...
		if(checkDataValidation()) {
			...
			boolean updateResult = stdm.updateStudent(std);	
			if(updateResult) {
				ShowAlertDialog.showSuccessfulAlert("Edit Student", "Update to Database Successful!");
			}
			else {
				ShowAlertDialog.showErrorAlert("Edit Student", "Update to Database Failed!");
			}
		}
	}
